...
export type FlowEdgeData = {
  color?: string;
  edgeType?: "intake" | "routing" | "output" | "archive";
  offset?: number; // px offset to separate parallel lines
};

const EDGE_STYLES: Record<string, { dasharray?: string; width: number; opacity: number }> = {
  intake:   { width: 1.4, opacity: 0.55 },
  routing:  { dasharray: "6 3", width: 1.2, opacity: 0.5 },
  output:   { width: 1.2, opacity: 0.4 },
  archive:  { width: 0.8, opacity: 0.2 },
};
